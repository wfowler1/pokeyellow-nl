...
EarthBadgeText:
	db "AARDEBADGE@" ; "EARTHBADGE@"

VolcanoBadgeText:
	db "VULKAANBADGE@" ; "VOLCANOBADGE@"

MarshBadgeText:
	db "MOERASBADGE@" ; "MARSHBADGE@"

SoulBadgeText:
	db "ZIELBADGE@" ; "SOULBADGE@"

RainbowBadgeText:
	db "REGENBOOGBADGE@" ; "RAINBOWBADGE@"

ThunderBadgeText:
	db "DONDERBADGE@" ; "THUNDERBADGE@"

CascadeBadgeText:
	db "WATERVALBADGE@" ; "CASCADEBADGE@"
