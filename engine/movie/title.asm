...
LoadCopyrightTiles:
	...
	lb bc, BANK(NintendoCopyrightLogoGraphics), ((TextBoxGraphics + $10 - NintendoCopyrightLogoGraphics) / TILE_SIZE) - $1 ; bug: overflows into text box graphics and copies the "A" tile
	call CopyVideoData
	hlcoord 2, 7
